...
set BUILD_DEST_LIB_DIR_RELEASE=%BUILD_DIR%\lib\Release
...
if not exist "%BUILD_DEST_LIB_DIR_RELEASE%\" mkdir "%BUILD_DEST_LIB_DIR_RELEASE%"
...
cmake %SOURCE_DIR% -A x64 -DCMAKE_CONFIGURATION_TYPES=RelWithDebInfo;Release
...
xcopy "%DIR_OPENCV_LIB%\*" "%BUILD_DEST_LIB_DIR_RELEASE%" /E /I /Y
